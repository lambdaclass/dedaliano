...
There is a [Rust implementation](engine/) of the solver core in the `engine/` directory with 2,000+ passing tests (1,900+ validation tests verified against AISC 360, Eurocode 3/8, ASCE 7, AASHTO, NAFEMS, ANSYS VM, SAP2000, Code_Aster, MASTAN2, NDS, EC5, EC7, EC4, CIRSOC 102/103/201, and 30+ textbook references). The intent is to compile it to WebAssembly via [wasm-pack](https://rustwasm.github.io/wasm-pack/) for near-native performance in the browser.
...
| **Testing** | [Vitest 3.2](https://vitest.dev) (1,050+ TS tests) + [Cargo test](https://doc.rust-lang.org/cargo/commands/cargo-test.html) (2,000+ Rust tests across 225 validation files) |
